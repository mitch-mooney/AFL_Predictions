...
# TODO: fit_dist1 through fit_dist10 need to be generated before running these lines.
# Create them by filtering score_data_lean by pred_cat (1-10) before running this block.
